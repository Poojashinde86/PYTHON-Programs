...
salience=1)
 ...
 #when the user's input doesn't match any disease in the knowledge 
base
...
salience=-998)
 ...
 print("The common medications and procedures suggested by 
other real doctors are: \n")
 print(treatments + "\n")
 @Rule(
 Fact(action="find_disease"),
...
nausea,blurred_vision,):
 print("\nThe bot did not find any diseases that match your 
exact symptoms.")
 lis = [
 headache,
 back_pain,
 ...
 if temp_list[j] == lis[j] and (lis[j] == "high" or
lis[j] == "low" or lis[j] == "yes"):
 count = count + 1
 if count > max_count:
 max_count = count
 max_disease = val
